...
Backend-agnostic GPU device surface for Catty: resources, command recording, and three **logical** queues (Graphics / Compute / Transfer).
...
- Device/Manager/Submit: RHI thread (`CattyRHI`)

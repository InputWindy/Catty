 ...
 *
 *   // Unicast
 *   Catty::TDelegate<int(int)> OnScale;
 *   OnScale.BindRaw(&User, &FUser::Scale);
 *   const int Scaled = OnScale.Execute(3); // 6
 *
 *   // Multicast
 *   Catty::TMulticastDelegate<void(int)> OnAdd;
 *   const Catty::FDelegateHandle H = OnAdd.AddRaw(&User, &FUser::Add);
 ...
 *   CATTY_DECLARE_DELEGATE_OneParam(FOnInt, int);
 *   CATTY_DECLARE_MULTICAST_DELEGATE_OneParam(FOnIntMulti, int);
 *   FOnInt A;
 *   FOnIntMulti B;
 * ```
 */
...
#define CATTY_DECLARE_DELEGATE(DelegateName) \
	using DelegateName = ::Catty::TDelegate<void()>

#define CATTY_DECLARE_DELEGATE_RetVal(RetType, DelegateName) \
	using DelegateName = ::Catty::TDelegate<RetType()>

#define CATTY_DECLARE_DELEGATE_OneParam(DelegateName, Param1Type) \
	using DelegateName = ::Catty::TDelegate<void(Param1Type)>

#define CATTY_DECLARE_DELEGATE_RetVal_OneParam(RetType, DelegateName, Param1Type) \
	using DelegateName = ::Catty::TDelegate<RetType(Param1Type)>

#define CATTY_DECLARE_DELEGATE_TwoParams(DelegateName, Param1Type, Param2Type) \
	using DelegateName = ::Catty::TDelegate<void(Param1Type, Param2Type)>

#define CATTY_DECLARE_DELEGATE_RetVal_TwoParams(RetType, DelegateName, Param1Type, Param2Type) \
	using DelegateName = ::Catty::TDelegate<RetType(Param1Type, Param2Type)>

#define CATTY_DECLARE_DELEGATE_ThreeParams(DelegateName, Param1Type, Param2Type, Param3Type) \
	using DelegateName = ::Catty::TDelegate<void(Param1Type, Param2Type, Param3Type)>

#define CATTY_DECLARE_DELEGATE_RetVal_ThreeParams(RetType, DelegateName, Param1Type, Param2Type, Param3Type) \
	using DelegateName = ::Catty::TDelegate<RetType(Param1Type, Param2Type, Param3Type)>

#define CATTY_DECLARE_DELEGATE_FourParams(DelegateName, Param1Type, Param2Type, Param3Type, Param4Type) \
	using DelegateName = ::Catty::TDelegate<void(Param1Type, Param2Type, Param3Type, Param4Type)>

#define CATTY_DECLARE_MULTICAST_DELEGATE(DelegateName) \
	using DelegateName = ::Catty::TMulticastDelegate<void()>

#define CATTY_DECLARE_MULTICAST_DELEGATE_OneParam(DelegateName, Param1Type) \
	using DelegateName = ::Catty::TMulticastDelegate<void(Param1Type)>

#define CATTY_DECLARE_MULTICAST_DELEGATE_TwoParams(DelegateName, Param1Type, Param2Type) \
	using DelegateName = ::Catty::TMulticastDelegate<void(Param1Type, Param2Type)>

#define CATTY_DECLARE_MULTICAST_DELEGATE_ThreeParams(DelegateName, Param1Type, Param2Type, Param3Type) \
	using DelegateName = ::Catty::TMulticastDelegate<void(Param1Type, Param2Type, Param3Type)>

#define CATTY_DECLARE_MULTICAST_DELEGATE_FourParams(DelegateName, Param1Type, Param2Type, Param3Type, Param4Type) \
	using DelegateName = ::Catty::TMulticastDelegate<void(Param1Type, Param2Type, Param3Type, Param4Type)>

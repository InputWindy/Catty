...
/**
 * Package / FResource facade. Lives in the CResourceManager plugin DLL.
 * Owns FResourceServer (private Plugin/Private impl), FPackage & FResource pools,
 ...
 */
class CATTY_CRESOURCEMANAGER_MODULE_API FResourceManager : public ILuaBindable
{
public:

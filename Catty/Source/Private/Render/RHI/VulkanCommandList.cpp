	...
	FRHIFence* SignalFence)
{
	...
	{
		CATTY_CORE_ERROR("FVulkanQueue::Submit: native queue is null");
		return;
	}
	...
	for (std::uint32_t Index = 0; Index < Count; ++Index)
	{
		...
		{
			CATTY_CORE_ERROR("FVulkanQueue::Submit: invalid command list");
			return;
		}
	...
	{
		CATTY_CORE_ERROR("FVulkanQueue::Submit: vkQueueSubmit failed ({})", static_cast<int>(Result));
	}
}

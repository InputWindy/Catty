...
test("FakeCattyWorldServer rejects extra request fields before creating world state", async (t) => {
...
test("FakeCattyWorldServer returns structured unknown-tool and invalid-argument results", async (t) => {
  const fake = await startFakeCattyWorldServer();
  t.after(() => fake.close());
